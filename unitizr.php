 ...
 * Description:       For WooCommerce, adds number of days, or any increment, to cart and checkout. Opens under WooCommerce > Settings > Products > unitizr.
 * Version:           1.0.44
 * Author:            Larry Judd
...
if (!defined('UNITIZR_VER')) { define('UNITIZR_VER', '1.0.44'); } 
